    ...
    <div className="app">
      ...
      <footer className="footer">
        <div className="container">
          ...
          <p>&copy; {new Date().getFullYear()} MapleCast | Written with Cursor AI | <a href="https://github.com/screech24/maplecast-weather/blob/main/CHANGELOG.md" target="_blank" rel="noopener noreferrer" className="version">v1.9.1</a></p>
        </div>
      </footer>
